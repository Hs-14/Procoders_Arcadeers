...
d_width=800
d_height=600
bg=pygame.transform.scale(pygame.image.load('tanks/bg1.png'),(d_width,d_height))
dg=pygame.transform.scale(pygame.image.load('tanks/bg2.png'),(d_width,d_height*7//60))
fps=30
clock=pygame.time.Clock()
win=pygame.display.set_mode((d_width,d_height))
pygame.display.set_caption("Tanks")
game_icon=pygame.image.load('tanks/tankicon.png')
pygame.display.set_icon(pygame.transform.scale(game_icon,(32,32)))
exp=[]
door=pygame.transform.scale(pygame.image.load('tanks/door.jpg'),(d_width,d_height))
for i in range(1,16):
    exp.append(pygame.image.load('tanks/exp%d.png'%i))
tank_body=[pygame.image.load('tanks/t_body1.png'),pygame.image.load('tanks/t_body2.png'),pygame.image.load('tanks/t_body3.png'),pygame.image.load('tanks/t_body4.png'),pygame.image.load('tanks/t_body5.png')]
tank_turret=[pygame.image.load('tanks/t_turret1.png'),pygame.image.load('tanks/t_turret2.png'),pygame.image.load('tanks/t_turret3.png'),pygame.image.load('tanks/t_turret4.png'),pygame.image.load('tanks/t_turret5.png')]
##############################################################################################################################################################################################
#ALL CLASSES
...
class player(object):
    ...
    def fire(self,x_barrier,y_barrier,itur,ibod):
        ...
        fire1=pygame.image.load('tanks/firecircle1.png')
        g=10
...
def game_intro():
    ...
    while intro:
        ...
        tank=pygame.transform.scale(pygame.image.load('tanks/tank.png'),(d_width*3//4,d_height//2))
...
wall=pygame.transform.scale(pygame.image.load('tanks/wall.jpg'),(d_width//4,d_height//2))
def barriers(x,y):
...
def scores_init(name):
    con=sq.connect('tanks/scores.db')
    cur=con.cursor()
    try:
